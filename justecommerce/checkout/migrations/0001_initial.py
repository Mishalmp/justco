    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('od_status', models.CharField(choices=[('Return', 'Return'), ('Cancelled', 'Cancelled'), ('Pending', 'Pending'), ('Delivered', 'Delivered'), ('Shipped', 'Shipped'), ('Processing', 'Processing')], default='Pending', max_length=150)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('Return', 'Return'), ('Cancelled', 'Cancelled'), ('Pending', 'Pending'), ('Delivered', 'Delivered'), ('Shipped', 'Shipped'), ('Processing', 'Processing')], default='Pending', max_length=150)),
